...
(function($)
{
	...
	$.dateRangePickerLanguages =
	{
		...
		'en':
		{
			...
			'week-6' : 'Sab',
			'week-7' : 'Dom',
			'month-name': ['Janeiro','Feverreiro','Março','Abril','Maio','Junho','Julho','Agosto','Setembro','Outubro','Novembro','Dezembro'],
			'shortcuts' : 'Atalhos',
			'past': 'Passado',
			'following':'últimos',
			'previous' : 'Anterior',
			...
			'next-month':'Mês',
			'next-year':'Ano',
			'less-than' : 'O período não pode ser maior que %d dias',
			'more-than' : 'O período não pode ser menor que %d dias',
			'default-more' : 'Selecione um período maior que %d dias',
			'default-single' : 'Por favor, selecione uma data',
			'default-less' : 'Selecione um período menos que %d dias',
			'default-range' : 'Por favor, selecione um período entre %d e %d dias',
			'default-default': 'Por favor, selecione um período'
		},
		'it':
		{
