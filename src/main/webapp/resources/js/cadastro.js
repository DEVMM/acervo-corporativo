...
function validarEmail() {
	...
	if (email != "") {
		...
		if (filtro.test(email)) {
			...
			$('input[name=e-mail]').css('text-transform', 'lowercase');
			$('input[name=e-mail]').css('width', '222px');
			return true;
		} else {
			$('input[name=e-mail]').css('background', '#fff');
			$('input[name=e-mail]').css('border', '1px solid red');
...
function validarEmail() {
	var email = $("#emailn").focus();
	if (email != "") {
		var filtro = /^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/i;
		if (filtro.test(email)) {
			$('input[name=emailn]').css('background', '#fff');
			$('input[name=emailn]').css('border', '1px solid #0076bc'); 
			$('input[name=emailn]').css('color', '#7e807a');
			$('input[name=emailn]').css('border-radius', '30px');
			$('input[name=emailn]').css('font-family',
					'flama-basic, Arial, Helvetica, sans-serif');
			$('input[name=emailn]').css('font-size', '14px');
			$('input[name=emailn]').css('margin-left', '24px');
			$('input[name=emailn]').css('padding', '9px 27px');
			$('input[name=emailn]').css('text-transform', 'lowercase');
			$('input[name=emailn]').css('width', '235px');
			$('input[name=emailn]').css('height', '15px');
			return true;
		} else {
			$('input[name=emailn]').css('background', '#fff');
			$('input[name=emailn]').css('border', '1px solid red');
			$('input[name=emailn]').css('color', '#000');
			$('input[name=emailn]').css('border-radius', '30px');
			$('input[name=emailn]').css('font-family',
					'flama-basic, Arial, Helvetica, sans-serif');
			$('input[name=emailn]').css('font-size', '14px');
			...
			$('input[name=emailn]').css('padding', '9px 27px');
			$('input[name=emailn]').css('text-transform', 'lowercase');
			$('input[name=emailn]').css('width', '186px');
			$('input[name=emailn]').css('height', '15px');
			$('input[name=emailn]').addClass('txtempty');
			$('input[name=emailn]').attr('placeholder', 'digite um e-mail v\u00e1lido!');
			return false;
		}
	} else {
		$('input[name=emailn]').css('background', '#fff');
...
function validarLogin() {
	...
	if (!($("#campos-login").val().length >= 2)) {
		$("#campos-login").focus();
		$('input[id=campos-login]').css('background', '#fff');
		$('input[id=campos-login]').css('border', '1px solid red');
		$('input[id=campos-login]').css('color', '#000');
		$('input[id=campos-login]').css('border-radius', '30px');
		$('input[id=campos-login]').css('font-family',
				'flama-basic, Arial, Helvetica, sans-serif');
		$('input[id=campos-login]').css('font-size', '14px');
		$('input[id=campos-login]').css('margin-left', '5px');
		$('input[id=campos-login]').css('padding', '9px 15px');
		$('input[id=campos-login]').css('text-transform', 'lowercase');
		$('input[id=campos-login]').css('width', '206px');
		$('input[id=campos-login]').css('height', '12px');
		$('input[id=campos-login]').addClass('txtempty');
		$('input[id=campos-login]').attr('placeholder', 'Campo Obrigatorio v\u00e1lido!');
		val = false;
	} else {
		$('input[id=campos-login]').css('background', '#fff');
		$('input[id=campos-login]').css('border', '1px solid #ccc');
		$('input[id=campos-login]').css('color', '#7e807a');
		$('input[id=campos-login]').css('border-radius', '30px');
		$('input[id=campos-login]').css('font-family',
				'flama-basic, Arial, Helvetica, sans-serif');
		$('input[id=campos-login]').css('font-size', '14px');
...
function validarLoginCuida() {
	var val = true;
	if (!validarEmail()) {
		$("#campos-cuidado").focus();
		val = false;
	}
	if (!($("#campos-cuidado").val().length >= 2)) {
		$("#campos-cuidado").focus();
		$('input[id=campos-cuidado]').css('background', '#fff');
		$('input[id=campos-cuidado]').css('border', '1px solid red');
		$('input[id=campos-cuidado]').css('color', '#000');
		$('input[id=campos-cuidado]').css('border-radius', '30px');
		$('input[id=campos-cuidado]').css('font-family',
				'flama-basic, Arial, Helvetica, sans-serif');
		$('input[id=campos-cuidado]').css('font-size', '14px');
		$('input[id=campos-cuidado]').css('margin-left', '5px');
		$('input[id=campos-cuidado]').css('padding', '9px 15px');
		$('input[id=campos-cuidado]').css('text-transform', 'lowercase');
		$('input[id=campos-cuidado]').css('width', '180px');
		$('input[id=campos-cuidado]').css('height', '12px');
		$('input[id=campos-cuidado]').addClass('txtempty');
		$('input[id=campos-cuidado]').attr('placeholder', 'Campo Obrigatorio v\u00e1lido!');
		val = false;
	} else {
		$('input[id=campos-cuidado]').css('background', '#fff');
		$('input[id=campos-cuidado]').css('border', '1px solid #ccc');
		$('input[id=campos-cuidado]').css('color', '#7e807a');
		$('input[id=campos-cuidado]').css('border-radius', '30px');
		$('input[id=campos-cuidado]').css('font-family',
				'flama-basic, Arial, Helvetica, sans-serif');
		$('input[id=campos-cuidado]').css('font-size', '14px');
...
height: 12px; 
*/
function validarFormJuridico() {
	var val = true;
	if (!validarEmail()) {
		$("#campos-valide").focus();
		val = false;
	}
	if (!($("#campos-valide").val().length >= 2)) {
		$("#campos-valide").focus();
		$('input[id=campos-valide]').css('background', '#fff');
		$('input[id=campos-valide]').css('border', '1px solid red');
		$('input[id=campos-valide]').css('color', '#000');
		$('input[id=campos-valide]').css('border-radius', '30px');
		$('input[id=campos-valide]').css('font-family',
				'flama-basic, Arial, Helvetica, sans-serif');
		$('input[id=campos-valide]').css('font-size', '14px');
		$('input[id=campos-valide]').css('margin-left', '24px');
		$('input[id=campos-valide]').css('padding', '9px 27px');
		$('input[id=campos-valide]').css('text-transform', 'lowercase');
		$('input[id=campos-valide]').css('width', '222px');
		$('input[id=campos-valide]').addClass('txtempty');
		$('input[id=campos-valide]').attr('placeholder', 'Campo Obrigatorio v\u00e1lido!');
		val = false;
	} else {
		$('input[id=campos-valide]').css('background', '#fff');
		$('input[id=campos-valide]').css('border', '1px solid #ccc');
		$('input[id=campos-valide]').css('color', '#7e807a');
		$('input[id=campos-valide]').css('border-radius', '30px');
		$('input[id=campos-valide]').css('font-family',
				'flama-basic, Arial, Helvetica, sans-serif');
		$('input[id=campos-valide]').css('font-size', '14px');
	...
	if (!($("#campo-id").val().length >= 2)) {
		$("#campo-id").focus();
		$('input[id=campo-id]').css('background', '#fff');
		$('input[id=campo-id]').css('border', '1px solid red');
		$('input[id=campo-id]').css('color', '#000');
		$('input[id=campo-id]').css('border-radius', '30px');
		$('input[id=campo-id]').css('font-family',
				'flama-basic, Arial, Helvetica, sans-serif');
		$('input[id=campo-id]').css('font-size', '14px');
		$('input[id=campo-id]').css('margin-left', '24px');
		$('input[id=campo-id]').css('padding', '9px 20px');
		$('input[id=campo-id]').css('text-transform', 'lowercase');
		$('input[id=campo-id]').css('width', '205px');
		$('input[id=campo-id]').css('height', '14px');
		$('input[id=campo-id]').addClass('txtempty');
		$('input[id=campo-id]').attr('placeholder', 'Campo Obrigatorio v\u00e1lido!');
		val = false;
	} else {
		$('input[id=campo-id]').css('background', '#fff');
		$('input[id=campo-id]').css('border', '1px solid #ccc');
		$('input[id=ccampo-id]').css('color', '#7e807a');
		$('input[id=campo-id]').css('border-radius', '30px');
		$('input[id=campo-id]').css('font-family',
				'flama-basic, Arial, Helvetica, sans-serif');
		$('input[id=campo-id]').css('font-size', '14px');
