			...
			<div class="content-cadastro">
				...
				<form action="/GrupoMMDBM/administracao/cadastrar-empresa/salvar" method="POST">
					<div class="column">
						<div class="form-perfil form-profissional">
							...
							<div class="input-box">
								...
								<input type="text" name="inscricaoEstadual" maxlength="200" placeholder="Digite a InscriÁ„o Estadual" required="required"/> </div>
							<!-- end input-box -->
							<br />
							<br />
							<br /> 
						...
						<div class="column2">
							<div class="form-profissional" id="form-profissional">
								<h5>
									<strong class="icon-lado"></strong>InformaÁıes da Assinatura
								</h5>
								<div class="input-box">
									<label for="cep" style="padding-top: 10px">CÛdigo</label>
									<input class="campo" required="required"type="text" name="codigo" placeholder="CÛdigo da Assinatura" />
								</div>
								<div class="input-box">
									<label for="logradouro" style="padding-top: 10px">Data CriaÁ„o</label>
					...
					<div class="column2">
						<div class="form-profissional" id="form-profissional">
							<h5>
								<strong class="icon-lado"></strong>EndereÁo de CobranÁa
							</h5>
							<div id="loadingCEP" style="display: none">
								<img alt="" src="${myUrl}resources/images/AjaxLoader.gif">
							</div>
						...
						<div class="form-endereco" id='form-endereco'>
							...
							<!-- end input-box -->
							<div class="input-box">
								<label for="pais" style="padding-top: 10px">PaÌs</label> <select
									class="campopais" id="pais" name="enderecoCobranca.pais">
									<option value="">Selecione</option>
									<option value="AÅfrica do Sul">AÅfrica do Sul</option>
									<option value="Alb‚nia">Alb‚nia</option>
									<option value="Alemanha">Alemanha</option>
									<option value="Andorra">Andorra</option>
									<option value="Angola">Angola</option>
									...
									<option value="Hong Kong">Hong Kong</option>
									<option value="Hungria">Hungria</option>
									<option value="IÈmen">IÈmen</option>
									<option value="Ilhas Cayman">Ilhas Cayman</option>
									<option value="Ilhas Cook">Ilhas Cook</option>
									<option value="Ilhas CuraÁao">Ilhas CuraÁao</option>
									<option value="Ilhas Marshall">Ilhas Marshall</option>
									...
									<option value="Portugal">Portugal</option>
									<option value="Qatar">Qatar</option>
									<option value="QuÈnia">QuÈnia</option>
									<option value="Rep. Dominicana">Rep. Dominicana</option>
									<option value="Rep. Tcheca">Rep. Tcheca</option>
									<option value="Reunion">Reunion</option>
									<option value="RomÈnia">RomÈnia</option>
									<option value="Ruanda">Ruanda</option>
									<option value="R˙ssia">R˙ssia</option>
									<option value="Saipan">Saipan</option>
									<option value="Samoa Americana">Samoa Americana</option>
					...
					<div class="column2">
						<div class="form-profissional" id="form-profissional">
							<h5>
								<strong class="icon-lado"></strong>EndereÁo de Entrega
							</h5>
							<div id="loadingCEP" style="display: none">
													<img alt="" src="${myUrl}resources/images/AjaxLoader.gif">
												</div>
