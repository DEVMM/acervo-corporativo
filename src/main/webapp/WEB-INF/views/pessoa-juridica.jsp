				...
				<form action="/GrupoMMDBM/dbm/cadastrar-empresa/salvar" method="POST">
					<div class="column">
						...
						<div class="form-profissional" id="form-profissional">
							<h5>
							<strong class="icon-lado"></strong>Endereço Comercial
						</h5>
							<div class="input-box">
                    ...
                    <a class="btn-depois" id="disable3"  title="Preencher agora">Preencher agora</a>-->
							...
							<div class="form-endereco" id='form-endereco'>
								<h4>&nbsp;</h4>
								<div class="input-box">
									<label for="cidade" style="padding-top: 10px">Área de Atuação</label>
								...
								<!-- end input-box -->
								<div class="input-box">
									<label for="estado" style="padding-top: 10px">Nível Hieráquico</label>
						...
						<div class="column2">
							<div class="form-profissional" id="form-profissional">
								...
								<div class="input-box">
			                        ...
			                        <span class="localizarCep"> <a href="#">Localizar Responsável</a></span>
			                    </div>
								<div class="input-box">
